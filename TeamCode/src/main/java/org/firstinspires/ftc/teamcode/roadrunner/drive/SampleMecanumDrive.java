...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, Constants.LEFT_FRONT);
        leftRear = hardwareMap.get(DcMotorEx.class, Constants.LEFT_BACK);
        rightRear = hardwareMap.get(DcMotorEx.class, Constants.RIGHT_BACK);
        rightFront = hardwareMap.get(DcMotorEx.class, Constants.RIGHT_FRONT);
